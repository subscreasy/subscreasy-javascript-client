...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentation.SubscriptionPlan();
  });
  ...
  describe('SubscriptionPlan', function() {
    it('should create an instance of SubscriptionPlan', function() {
      ...
      //var instane = new ApiDocumentation.SubscriptionPlan();
      //expect(instance).to.be.a(ApiDocumentation.SubscriptionPlan);
    });
