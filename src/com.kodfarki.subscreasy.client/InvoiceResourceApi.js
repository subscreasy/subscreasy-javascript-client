...
* @version 1.0.0
*/
export default class InvoiceResourceApi {
    ...
    */
     ...
     */
    createInvoiceUsingPOST(invoice, callback) {
     ...
     */
    deleteInvoiceUsingDELETE(id, callback) {
      let postBody = null;
     ...
     */
    getAllInvoicesUsingGET(callback) {
      let postBody = null;
     ...
     * data is of type: {@link Array.<module:com.kodfarki.subscreasy.client.model/Invoice>}
     */
    getInvoiceBySubscriberUsingGET(subscriberSecureId, callback) {
      let postBody = null;
     ...
     * data is of type: {@link module:com.kodfarki.subscreasy.client.model/Invoice}
     */
    getInvoiceUsingGET(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * data is of type: {@link module:com.kodfarki.subscreasy.client.model/Invoice}
     */
    updateInvoiceUsingPUT(invoice, callback) {
      let postBody = invoice;
      // verify the required parameter 'invoice' is set
      if (invoice === undefined || invoice === null) {
