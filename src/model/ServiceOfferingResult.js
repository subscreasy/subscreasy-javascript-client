...
(function(root, factory) {
   ...
   * @module model/ServiceOfferingResult
   * @version 1.0
   */

  /**
   * Constructs a new <code>ServiceOfferingResult</code>.
   * @alias module:model/ServiceOfferingResult
   * @class
   */
   ...
   * @param {module:model/ServiceOfferingResult} obj Optional instance to populate.
   * @return {module:model/ServiceOfferingResult} The populated <code>ServiceOfferingResult</code> instance.
   */
