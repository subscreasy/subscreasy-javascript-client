...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Company', 'model/Coupon', 'model/Offer', 'model/SavedCard', 'model/ServiceInstance', 'model/Subscriber'], factory);
   ...
   * @module model/Subsription
   * @version 1.0
   */

  /**
   * Constructs a new <code>Subsription</code>.
   * @alias module:model/Subsription
   * @class
   * @param company {module:model/Company} 
   * @param offer {module:model/Offer} 
   */
   ...
   * @param {module:model/Subsription} obj Optional instance to populate.
   * @return {module:model/Subsription} The populated <code>Subsription</code> instance.
   */
  ...
  /**
   * @member {module:model/Coupon} appliedCoupon
   */
  ...
  /**
   * @member {module:model/SavedCard} card
   */
  ...
  /**
   * @member {module:model/Subsription.StatusEnum} status
   */
  exports.prototype['status'] = undefined;
  /**
   * @member {module:model/Subscriber} subscriber
   */
