...
(function(root, factory) {
   ...
   * @module model/ServiceInstanceResult
   * @version 1.0
   */

  /**
   * Constructs a new <code>ServiceInstanceResult</code>.
   * @alias module:model/ServiceInstanceResult
   * @class
   */
   ...
   * @param {module:model/ServiceInstanceResult} obj Optional instance to populate.
   * @return {module:model/ServiceInstanceResult} The populated <code>ServiceInstanceResult</code> instance.
   */
