...
(function(root, factory) {
   ...
   * @module model/SavedCard
   * @version 1.0
   */

  /**
   * Constructs a new <code>SavedCard</code>.
   * @alias module:model/SavedCard
   * @class
   */
   ...
   * @param {module:model/SavedCard} obj Optional instance to populate.
   * @return {module:model/SavedCard} The populated <code>SavedCard</code> instance.
   */
