...
(function(root, factory) {
   ...
   * @module model/ChargingLog
   * @version 1.0
   */

  /**
   * Constructs a new <code>ChargingLog</code>.
   * @alias module:model/ChargingLog
   * @class
   */
   ...
   * @param {module:model/ChargingLog} obj Optional instance to populate.
   * @return {module:model/ChargingLog} The populated <code>ChargingLog</code> instance.
   */
  ...
  /**
   * @member {module:model/ChargingLog} parent
   */
  exports.prototype['parent'] = undefined;
  /**
   * @member {module:model/ChargingLog.PaymentGatewayEnum} paymentGateway
   */
  ...
  /**
   * @member {module:model/ChargingLog.ReasonEnum} reason
   */
  ...
  /**
   * @member {module:model/ChargingLog.StatusEnum} status
   */
