...
(function(root, factory) {
   ...
   * @module model/ManagedUserVM
   * @version 1.0
   */

  /**
   * Constructs a new <code>ManagedUserVM</code>.
   * @alias module:model/ManagedUserVM
   * @class
   * @param login {String} 
   */
   ...
   * @param {module:model/ManagedUserVM} obj Optional instance to populate.
   * @return {module:model/ManagedUserVM} The populated <code>ManagedUserVM</code> instance.
   */
