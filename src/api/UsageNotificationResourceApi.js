...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UsageNotification'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/UsageNotification'));
  } else {
   ...
   * @module api/UsageNotificationResourceApi
   * @version 1.0
   */

  /**
   * Constructs a new UsageNotificationResourceApi. 
   * @alias module:api/UsageNotificationResourceApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/UsageNotificationResourceApi~createUsageNotificationUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UsageNotification} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * createUsageNotification
     * @param {module:model/UsageNotification} usageNotification usageNotification
     * @param {module:api/UsageNotificationResourceApi~createUsageNotificationUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UsageNotification}
     */
     ...
     * @callback module:api/UsageNotificationResourceApi~deleteUsageNotificationUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id id
     * @param {module:api/UsageNotificationResourceApi~deleteUsageNotificationUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/UsageNotificationResourceApi~getAllUsageNotificationsUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/UsageNotification>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * getAllUsageNotifications
     * @param {module:api/UsageNotificationResourceApi~getAllUsageNotificationsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/UsageNotification>}
     */
     ...
     * @callback module:api/UsageNotificationResourceApi~getUsageNotificationUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UsageNotification} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id id
     * @param {module:api/UsageNotificationResourceApi~getUsageNotificationUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UsageNotification}
     */
     ...
     * @callback module:api/UsageNotificationResourceApi~updateUsageNotificationUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UsageNotification} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/UsageNotification} usageNotification usageNotification
     * @param {module:api/UsageNotificationResourceApi~updateUsageNotificationUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UsageNotification}
     */
