...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ProductResourceApi~createProductUsingPOSTCallback
    ...
    /**
     * createProduct
     * @param {module:model/Product} product product
     * @param {module:api/ProductResourceApi~createProductUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ProductResourceApi~getAllCompanyProductUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ProductResourceApi~getAllCompanyProductUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ProductResourceApi~getAllProductsUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Product>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * getAllProducts
     * @param {module:api/ProductResourceApi~getAllProductsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Product>}
     */
     ...
     * @callback module:api/ProductResourceApi~getCompanyProductUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Product} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} companyName companyName
     * @param {Number} id id
     * @param {module:api/ProductResourceApi~getCompanyProductUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Product}
     */
     ...
     * @callback module:api/ProductResourceApi~getProductUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Product} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * getProduct
     * @param {Number} id id
     * @param {module:api/ProductResourceApi~getProductUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Product}
     */
     ...
     * @callback module:api/ProductResourceApi~updateProductUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Product} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * updateProduct
     * @param {module:model/Product} product product
     * @param {module:api/ProductResourceApi~updateProductUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Product}
     */
     ...
     * @callback module:api/ProductResourceApi~uploadFileUsingPOSTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ProductResourceApi~uploadFileUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
