...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChargingLog'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ChargingLog'));
  } else {
   ...
   * @module api/ChargingLogResourceApi
   * @version 1.0
   */

  /**
   * Constructs a new ChargingLogResourceApi. 
   * @alias module:api/ChargingLogResourceApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ChargingLogResourceApi~createChargingLogUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ChargingLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * createChargingLog
     * @param {module:model/ChargingLog} chargingLog chargingLog
     * @param {module:api/ChargingLogResourceApi~createChargingLogUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ChargingLog}
     */
     ...
     * @callback module:api/ChargingLogResourceApi~deleteChargingLogUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * deleteChargingLog
     * @param {Number} id id
     * @param {module:api/ChargingLogResourceApi~deleteChargingLogUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/ChargingLogResourceApi~getAllChargingLogsUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ChargingLogResourceApi~getAllChargingLogsUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ChargingLogResourceApi~getChargingLogUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ChargingLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * getChargingLog
     * @param {Number} id id
     * @param {module:api/ChargingLogResourceApi~getChargingLogUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ChargingLog}
     */
     ...
     * @callback module:api/ChargingLogResourceApi~refundUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ChargingLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ChargingLogResourceApi~refundUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ChargingLog}
     */
     ...
     * @callback module:api/ChargingLogResourceApi~updateChargingLogUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ChargingLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * updateChargingLog
     * @param {module:model/ChargingLog} chargingLog chargingLog
     * @param {module:api/ChargingLogResourceApi~updateChargingLogUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ChargingLog}
     */
